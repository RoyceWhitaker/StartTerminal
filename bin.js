...
var welcomeText = `	=== Welcome! ===
	<a style="color:red" href="https://youtube.com">YouTube</a> - <a style="color:green" href="https://4chan.org">4chan</a> - <a style="color:lightblue" href="https://twitter.com">Twitter</a> - <a style="color:DodgerBlue" href="https://twitch.tv">Twitch</a> - <a style="color:DeepSkyBlue" href="https://antman.site">Antman.site</a>
...
var about = {
	main: function() {
		render("Based on the Terminal v2 project", "dodgerblue");
		render(
...
var search = {
	main: function() {
		render("Searches google. Try 'help search'")
	},
	helpText: 'Completes a google search. Can be called using "search (query)" or "s (query)"',
}